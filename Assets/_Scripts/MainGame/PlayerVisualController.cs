...
public class PlayerVisualController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        animator.SetLayerWeight(GlobalConstants.SHOOTING_LAYER_INDEX, 1);
    ...
    {
        animator.SetTrigger(GlobalConstants.TRIGGER_DIE);
    }
    
    public void TriggerRespawnAnimation()
    {
        animator.SetTrigger(GlobalConstants.TRIGGER_RESPAWN);
    }
